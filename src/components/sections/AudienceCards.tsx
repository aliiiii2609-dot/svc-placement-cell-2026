...
const CARDS: AudienceCard[] = [
  {
    ...
    body: 'A published recruitment calendar, eligibility screening by the cell, and a dedicated coordinator who runs your drive end to end.',
    points: [
      'Run a campus drive',
  ...
  },
  {
    ...
    body: 'Live drives, eligibility details, the CV vetting process, and prep resources curated by the cell.',
    points: [
      'Browse live drives',
      'Submit CV for vetting',
      'Read the CV guidelines',
    ],
    to: '/students/portal',
    brandColor: '#b8893b',
    Icon: GraduationCap,
